...
const styles = StyleSheet.create({
  ...
  subAdminNote: { color: '#4338CA', fontSize: 11, marginTop: 6, fontWeight: '600' },
  ...
  adminCard: { backgroundColor: '#EEF2FF', borderRadius: 14, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#C7D2FE' },
  adminTitle: { fontWeight: '700', color: '#3730A3' },
  adminSubtitle: { fontSize: 12, color: '#4338CA', marginTop: 4 },
