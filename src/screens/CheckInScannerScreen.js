...
const styles = StyleSheet.create({
  ...
  permissionBtn: { backgroundColor: '#4F46E5', borderRadius: 10, paddingVertical: 12, paddingHorizontal: 20 },
  ...
  scanAgain: { color: '#4F46E5', fontWeight: '600', textAlign: 'center', marginTop: 12, fontSize: 13 },
